      ...
      <DialogContent className="bg-slate-900 border-slate-700 text-slate-200 sm:max-w-lg">
        ...
        <div className="space-y-4">
          ...
          <div
            ...
            className="flex flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed border-slate-700 p-6 cursor-pointer hover:border-[#0084ff]/50 transition-colors"
          >
            {file ? (
              <>
                <FileText className="size-8 text-[#0084ff]" />
          ...
          {result && (
            <div className="rounded-lg border border-slate-700 p-4 space-y-2">
              ...
              <div className="flex items-center gap-4">
                {result.imported > 0 && (
                  <div className="flex items-center gap-1.5 text-[#0084ff] text-sm">
