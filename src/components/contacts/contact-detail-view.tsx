          ...
          <div className="flex flex-col h-full">
            ...
            <SheetHeader className="p-4 border-b border-slate-700/50">
              <div className="flex items-center gap-3">
                <Avatar className="size-12 bg-slate-800 border border-slate-700">
                  <AvatarFallback className="bg-[#0084ff]/10 text-[#0084ff] text-sm font-medium">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-3 mt-1.5 text-xs text-slate-400">
                    <button
                      onClick={copyPhone}
                      className="flex items-center gap-1 hover:text-[#0084ff] transition-colors cursor-pointer"
                    >
                      <Phone className="size-3" />
                      {contact.phone}
                      {copiedPhone ? (
                        <Check className="size-3 text-[#0084ff]" />
                      ) : (
            ...
            <Tabs defaultValue="details" className="flex-1 flex flex-col min-h-0">
              ...
              <TabsContent value="details" className="flex-1 overflow-y-auto px-4 py-3">
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    className="bg-[#0084ff] hover:bg-[#0055cc] text-white w-full"
                    size="sm"
                  >
                    {savingDetails ? (
              ...
              <TabsContent value="deals" className="flex-1 overflow-y-auto px-4 py-3">
                {loadingDeals ? (
                  <div className="flex items-center justify-center py-8">
                    <Loader2 className="size-5 animate-spin text-[#0084ff]" />
                  </div>
                ) : deals.length === 0 ? (
