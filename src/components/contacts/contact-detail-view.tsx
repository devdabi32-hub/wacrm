...
function SmartFieldInput({
  ...
  const base = 'bg-secondary border-border text-foreground h-8 text-sm placeholder:text-muted-foreground';
    ...
    case 'select':
      return (
        <select
          ...
          className={`w-full rounded-md border px-2 py-1.5 text-sm ${base} focus:outline-none focus:ring-1 focus:ring-primary`}
        >
              ...
              <TabsContent value="details" className="flex-1 overflow-y-auto px-4 py-3">
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    className="bg-primary hover:bg-primary/80 text-foreground w-full"
                    size="sm"
                  >
                    {savingDetails ? (
