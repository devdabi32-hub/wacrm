          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            <div className="grid gap-2">
              ...
              {linkedConversation && (
                <Link
                  href="/inbox"
                  className="mt-1 inline-flex items-center gap-1.5 self-start rounded-md bg-primary/10 px-2 py-1 text-xs text-primary hover:bg-[#0066cc]/20"
                >
              ...
              <div className="space-y-2 rounded-lg border border-border bg-card/50 p-3">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    className="flex-1 bg-primary text-foreground hover:bg-primary/80 disabled:opacity-50"
                  >
                    {statusAction === "won" ? (
          ...
          <div className="border-t border-border/50 bg-card/80 p-4">
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="flex-1 bg-primary text-foreground hover:bg-primary/80"
              >
