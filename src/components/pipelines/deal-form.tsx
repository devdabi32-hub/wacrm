          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            <div className="grid gap-2">
              ...
              <select
                ...
                className="h-9 w-full rounded-lg border border-slate-700 bg-slate-800 px-2.5 text-sm text-white outline-none focus:border-[#0084ff] focus:ring-1 focus:ring-[#0084ff]"
              >
              ...
              {linkedConversation && (
                <Link
                  href="/inbox"
                  className="mt-1 inline-flex items-center gap-1.5 self-start rounded-md bg-[#0084ff]/10 px-2 py-1 text-xs text-[#0084ff] hover:bg-[#0066cc]/20"
                >
            ...
            <div className="grid grid-cols-[1fr_110px] gap-3">
              ...
              <div className="grid gap-2">
                ...
                <select
                  ...
                  className="h-9 w-full rounded-lg border border-slate-700 bg-slate-800 px-2.5 text-sm text-white outline-none focus:border-[#0084ff]"
                >
              ...
              <div className="space-y-2 rounded-lg border border-slate-700 bg-slate-900/50 p-3">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    className="flex-1 bg-[#0084ff] text-white hover:bg-[#0055cc] disabled:opacity-50"
                  >
                    {statusAction === "won" ? (
          ...
          <div className="border-t border-slate-700/50 bg-slate-900/80 p-4">
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="flex-1 bg-[#0084ff] text-white hover:bg-[#0055cc]"
              >
