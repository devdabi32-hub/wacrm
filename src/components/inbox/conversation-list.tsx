      ...
      <div className="space-y-2 border-b border-slate-800 p-3">
        <div className="relative">
          ...
          <Input
            ...
            className="border-slate-700 bg-slate-800 pl-9 text-sm text-white placeholder-slate-500 focus:border-[#0084ff]/50"
          />
        </div>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isActive && "border-l-2 border-[#0084ff] bg-slate-800/70"
      )}
    >
      {/* Avatar */}
        ...
        <div className="mt-0.5 flex items-center justify-between gap-2">
          ...
          <div className="flex shrink-0 items-center gap-1.5">
            {conversation.unread_count > 0 && (
              <span className="flex h-4 min-w-4 items-center justify-center rounded-full bg-[#0084ff] px-1 text-[10px] font-bold text-white">
