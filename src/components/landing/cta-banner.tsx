...
export function CtaBanner() {
  return (
    <Section className="py-16 sm:py-20">
      <div
        className="relative overflow-hidden rounded-2xl border border-[#0084ff]/20 bg-slate-900/70 px-6 py-16 text-center sm:px-12 sm:py-20"
        style={{
          background:
      ...
      >
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <Link
            href="/signup"
            className="inline-flex items-center gap-2 rounded-lg bg-[#0084ff] px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#0066cc]"
          >
            Get started free
