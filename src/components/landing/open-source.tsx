    ...
    <Section id="self-host">
      ...
      <div className="mx-auto grid max-w-5xl grid-cols-1 gap-5 md:grid-cols-2">
        ...
        >
          ...
          <span className="mt-5 inline-flex items-center gap-1.5 text-sm font-medium text-[#0084ff] transition-colors group-hover:text-[#4da6ff]">
            ArnasDon/wacrm
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="group flex flex-col rounded-xl border border-[#0084ff]/20 bg-slate-900/40 p-6 transition-colors hover:border-[#0084ff]/40 hover:bg-slate-900/70"
        >
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0084ff]/10 text-[#0084ff]">
            <Server className="h-5 w-5" />
          </div>
          <h3 className="mt-4 flex flex-wrap items-center gap-2 text-base font-semibold text-white">
            Deploy on Hostinger
            <span className="rounded-full bg-[#0084ff]/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-[#0084ff]">
              Recommended
            </span>
          </h3>
          <p className="mt-1.5 text-sm leading-relaxed text-slate-400">
