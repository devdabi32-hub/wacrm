    ...
    <div className="space-y-6">
          ...
          return (
            <button
              ...
              className={`flex items-start gap-3 rounded-xl border p-4 text-left transition-all ${
                isSelected
                  ? 'border-[#0084ff] bg-[#0084ff]/5 ring-1 ring-[#0084ff]/30'
                ...
                return (
                  <button
                    ...
                    className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium transition-all ${
                      isSelected
                        ? 'border-[#0084ff]/30 bg-[#0084ff]/10 text-[#0084ff]'
          ...
          {loadingFields ? (
            ...
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-[minmax(0,1fr)_140px_minmax(0,1fr)]">
              <select
                ...
                className="h-9 rounded-lg border border-slate-700 bg-slate-800 px-2.5 text-sm text-white outline-none focus:border-[#0084ff] focus:ring-1 focus:ring-[#0084ff]"
              >
              ...
              <input
                ...
                placeholder="Value"
                className="h-9 rounded-lg border border-slate-700 bg-slate-800 px-2.5 text-sm text-white outline-none placeholder:text-slate-500 focus:border-[#0084ff] focus:ring-1 focus:ring-[#0084ff]"
              />
            </div>
          )}
        </div>
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-4">
        ...
        {loadingCount ? (
          <div className="flex items-center gap-2">
            <Loader2 className="h-4 w-4 animate-spin text-[#0084ff]" />
      ...
      <div className="flex items-center justify-between border-t border-slate-800 pt-4">
        ...
        <Button
          onClick={onNext}
          disabled={!isValid}
          className="bg-[#0084ff] text-white hover:bg-[#0055cc] disabled:opacity-50"
        >
          Next
