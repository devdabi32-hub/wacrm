    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5">
              {loadingReach ? (
                <Loader2 className="h-3 w-3 animate-spin text-[#0084ff]" />
              ) : (
                <>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          >
            <Send className={`mt-0.5 h-4 w-4 ${timing === 'now' ? 'text-[#0084ff]' : 'text-slate-400'}`} />
            <div>
      ...
      {/* Processing overlay */}
      {isProcessing && (
        <div className="rounded-xl border border-[#0084ff]/20 bg-[#0084ff]/5 p-4">
          <div className="mb-2 flex items-center justify-between">
            ...
            <span className="text-xs font-medium text-[#0084ff]">{progress}%</span>
          </div>
          <div className="h-1.5 w-full rounded-full bg-slate-800">
            <div
              className="h-1.5 rounded-full bg-[#0084ff] transition-all duration-300"
