          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4">
            {TEMPLATE_ORDER.map((slug) => {
              ...
              return (
                ...
                >
                  <div className="mb-3 flex h-9 w-9 items-center justify-center rounded-lg bg-[#0084ff]/10 text-[#0084ff] group-hover:bg-[#0066cc]/15">
  ...
  return (
    <li className="rounded-xl border border-slate-800 bg-slate-900 transition-colors hover:border-slate-700">
      <div className="flex items-center gap-4 p-4">
        <div
          className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-[#0084ff]/10"
          aria-hidden
        >
