...
const CLASSES = {
  ...
  li: 'pl-1',
  blockquote: 'my-4 rounded-r-lg border-l-4 border-[#0084ff] bg-[#0084ff]/5 px-4 py-3 text-slate-200',
  hr: 'my-8 border-t border-slate-800',
  a: 'text-[#0084ff] underline decoration-transparent underline-offset-2 transition-colors hover:decoration-[#0084ff]/60',
