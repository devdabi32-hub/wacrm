...
export const SITE_NAME = 'Tour and Travel CRM'
...
export const SITE_DESCRIPTION =
  'A Tour and Travel CRM built on WhatsApp® for Indian SMBs: shared inbox, contact hub, sales pipelines, broadcasts, and no-code automations — built on the official WhatsApp Business API.'
